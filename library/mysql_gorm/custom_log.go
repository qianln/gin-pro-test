...
func NewCustomLog(options ...Options) gormLog.Interface {
	var (
		infoStr      = "%s\n[info] "
		warnStr      = "%s\n[warn] "
		errStr       = "%s\n[error] "
	...
	logConf := gormLog.Config{
		SlowThreshold: time.Second * system.Config.GetDuration("Mysql.SlowThreshold"),
